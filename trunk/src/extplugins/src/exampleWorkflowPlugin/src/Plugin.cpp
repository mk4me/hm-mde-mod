...
VDF_SERVICE_BEGIN(ExampleWorkflowService, "{880E9240-FCE3-4E93-B7C3-FC58A785B9A2}")
	...
	VDF_ADD_DATA_PROCESSOR(ExampleIntProccesorStatistic, core::UID::GenerateUniqueID("{40FB529B-9DFD-4A8F-B4F5-8C840CD75BBD}"))
	VDF_ADD_DATA_PROCESSOR(ExampleIntProccesorFilter, core::UID::GenerateUniqueID("{232CF2AF-E13C-45AD-91D2-F378F988B2BE}"))
